...
class ShopifyRepeatRefundCandidatesTest extends TestCase
{
    ...
    {
        Http::fake(['*' => Http::response(['data' => ['orders' => ['pageInfo' => ['hasNextPage' => false, 'endCursor' => null], 'edges' => [['node' => ['legacyResourceId' => '1', 'name' => '#1', 'createdAt' => '2026-01-01', 'email' => 'a@x.com', 'displayFinancialStatus' => 'PARTIALLY_REFUNDED', 'totalPriceSet' => ['shopMoney' => ['amount' => '50.00', 'currencyCode' => 'USD']], 'refunds' => [['refundLineItems' => ['nodes' => [['subtotalSet' => ['shopMoney' => ['amount' => '12.50', 'currencyCode' => 'USD']]]]], 'transactions' => ['nodes' => [['kind' => 'REFUND', 'status' => 'SUCCESS', 'amountSet' => ['shopMoney' => ['amount' => '12.50', 'currencyCode' => 'USD']]]]]]]]]]]]])]);
